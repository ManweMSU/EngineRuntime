		...
		namespace Template
		{
			namespace Controls
			{
				...
				ENGINE_CONTROL_CLASS(FrameExtendedData)
					...
					ENGINE_DEFINE_REFLECTED_PROPERTY(BOOLEAN, WindowsTabbedTitle)
					ENGINE_DEFINE_REFLECTED_PROPERTY(BOOLEAN, WindowsTransientTitle)
					ENGINE_DEFINE_REFLECTED_PROPERTY(BOOLEAN, WindowsColoredTitle)
					ENGINE_DEFINE_REFLECTED_PROPERTY(COLOR, WindowsTitleColor)
